...
//        String input = zipCode.toString();
//        System.out.println("DET CUUUUU: " + input);
//        Intent sendIntent = new Intent(getBaseContext(), PhoneToWatchService.class);
//        sendIntent.putExtra("ZIPCODE", input);
//        startService(sendIntent);
//
//        Intent congressIntent = new Intent(MainActivity.this, CongressView.class);
...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currBttn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent sendIntent = new Intent(getBaseContext(), PhoneToWatchService.class);
                sendIntent.putExtra("ZIPCODE", "92840");
                startService(sendIntent);
